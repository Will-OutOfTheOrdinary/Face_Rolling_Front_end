...
fun WeBottomBar(selected: Int, onSelectedChanged: (Int) -> Unit,) {
    ...
    Row(modifier = Modifier.fillMaxWidth()) {
        TabItem(
            ...
            "首页",
            if (selected == 0) Color.Blue else Color.Gray,
            modifier = Modifier
                .weight(1f)
                .clickable {
                    onSelectedChanged(0)
        ...
        TabItem(
            ...
            "日历",
            if (selected == 1) Color.Blue else Color.Gray,
            modifier = Modifier
                .weight(1f)
                .clickable {
                    onSelectedChanged(1)
        ...
        TabItem(
            ...
            "团队",
            if (selected == 2) Color.Blue else Color.Gray,
            modifier = Modifier
                .weight(1f)
                .clickable {
                    onSelectedChanged(2)
        ...
        TabItem(
            ...
            "通知",
            if (selected == 3) Color.Blue else Color.Gray,
            modifier = Modifier
                .weight(1f)
                .clickable {
                    onSelectedChanged(3)
        ...
        TabItem(
            ...
            "个人",
            if (selected == 4) Color.Blue else Color.Gray,
            modifier = Modifier
                .weight(1f)
                .clickable {
                    onSelectedChanged(4)
