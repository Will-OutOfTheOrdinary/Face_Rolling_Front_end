...
private fun MonthHeader(monthState: MonthState) {
  Row {
    Text(monthState.currentMonth.year.toString(), style = MaterialTheme.typography.displayLarge)
    Text(monthState.currentMonth.month.name, style = MaterialTheme.typography.displayLarge)
